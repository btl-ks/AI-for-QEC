...
│   ├── <paper_id>_REPORT/<paper_id>_REPORT.md
│   └── assets/<paper_id>/     # 静态图表与结果索引
├── templates/                    # 既有论文导出模板
...
Torlai–Melko 已完成 L=4、L=6 各 11 个错误率的论文规模网格（单一训练 seed），结果、问题与局限见 [复现报告](../paper/summary/TORLAI_MELKO_2017_REPORT/TORLAI_MELKO_2017_REPORT.md)；项目仍没有 Stim/DEM adapter，也不将 smoke 指标当作论文性能结论。
