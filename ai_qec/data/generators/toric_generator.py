...
def sample_toric_splits(
    config: dict[str, Any], staging: Path,
) -> tuple[dict[str, dict[str, Any]], StabilizerCode, QECCircuit]:
    """Sample and write all splits using the configured backend and independent streams."""
